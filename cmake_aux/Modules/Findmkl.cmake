...
include("cmake_aux/Modules/Findmkl/utils.cmake")
...
if(HAVE_MKL)
    ...
    set(MKL_DEFINES -DUSE_MKL -DUSE_CBLAS)
    set(MKL_INCLUDE_DIR ${MKLINC})
    set(MKL_LIBS ${MKLLIB})
    add_library(mkl INTERFACE)
    target_include_directories(mkl INTERFACE ${MKL_INCLUDE_DIR})
    target_compile_definitions(mkl INTERFACE ${MKL_DEFINES})
    target_link_libraries(mkl INTERFACE ${MKL_LIBS})
else()
    if (MKLDNN_USE_MKL STREQUAL "NONE")
        return()
    endif()
